...
public class WebsocketStompConfiguration implements WebSocketMessageBrokerConfigurer {
    private static final Logger logger = LoggerFactory.getLogger(WebsocketStompConfiguration.class);

    private final WsUserInterceptor userInterceptor;
    public WebsocketStompConfiguration(WsUserInterceptor userInterceptor) {

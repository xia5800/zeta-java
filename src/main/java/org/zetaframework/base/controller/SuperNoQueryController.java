 ...
 * @author gcc
 */
public abstract class SuperNoQueryController<S extends IService<Entity>, Id extends Serializable, Entity, SaveDTO, UpdateDTO>
        extends SuperSimpleController<S, Entity>
        implements SaveController<Entity, SaveDTO>,
